import { Truck, CarTaxiFront, Bike, Car, Bus, ChevronRight, ChevronLeft, Sparkles } from 'lucide-react';
    ...
    <div className=' w-full bg-white py-20 px-4 overflow-hidden '>
      <div className="max-w-7xl  mx-auto">
        <motion.div
          ...
          className="flex items-end justify-between m-10 mt-0"
        >
          <div>
            ...
            <p className='text-zinc-400 text-sm mt-3 font-medium'>Choose the ride that fits your
              journey</p>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <motion.div
              whileTap={{ scale: 0.88 }}
              onClick={() => scroll("left")}
              className="w-11 h-11 rounded-2xl border border-zinc-200 bg-white flex items-center justify-center text-zinc-700 shadow-sm hover:bg-zinc-900 hover:text-white hover:border-zinc-900 disabled:opacity-25 disabled:hover:bg-white disabled:hover:text-zinc-900 disabled:hover:border-zinc-200 transition-all"
            >
        ...
        <div className="relative">
          <div
            ref={scrollRef}
            className="flex gap-5 pt-20 overflow-x-auto scroll-smooth pb-4 px-1" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
