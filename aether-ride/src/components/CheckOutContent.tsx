...
import { ArrowRight, MapPin, Navigation, Bike, Car, Truck, XCircle, CheckCircle, IndianRupee, Clock, CreditCard, ShieldCheck, Loader2, Banknote, Wallet } from 'lucide-react'
...
function CheckOutContent() {
    ...
    const { Icon } = VEHICLE_META[vehicle as keyof typeof VEHICLE_META]
    ...
    useEffect(() => {
        ...
        fetchActiveBooking()
    }, [driverId, drop, pickUp, vehicleId])

    const cancelBooking = async (id: string) => {
        try {
            await axios.get(CANCEL_BOOKING_ROUTE(id))
