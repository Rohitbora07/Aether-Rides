            ...
            {isActive && (
                <div className="mx-5 lg:mx-6 grid grid-cols-2 gap-2">
                    <div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4 flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-zinc-500 text-xs font-medium">ETA</p>
                            <p className="text-zinc-900 text-lg font-bold">
                                {Math.round(displayEta)} <span className="text-sm font-medium">min</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-zinc-950 rounded-2xl p-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-white text-lg font-bold">{booking?.fare || "-"}</p>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="bg-zinc-50 border border-zinc-100 rounded-2xl overflow-hidden">
                    ...
                    <div className="flex gap-3 p-4 border-b border-zinc-100">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-zinc-900">{booking?.pickUpAddress}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 p-4 border-b border-zinc-100">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[10px] text-zinc-400 uppercase font-bold tracking-wider mb-0.5">Drop Off</p>
                            <p className="text-sm text-zinc-900">{booking?.dropAddress}</p>
                        </div>
                    </div>
                </div>
            </div>
