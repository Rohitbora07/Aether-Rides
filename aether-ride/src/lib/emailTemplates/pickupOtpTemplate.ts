export const pickupOtpTemplate = (otp: string, driverName: string, vehicleModel: string, licensePlate: string) => {
...
<head>
  ...
  <title>Your Ride Has Arrived</title>
  </head>
          ...
          <tr>
            <td align="left" style="padding: 36px 40px 28px 40px;">
              ...
              <p style="color:#706E6B; font-size:13px; line-height:1.6; margin: 10px 0 0 0; font-weight: 400;">
                Please provide the verification code below to your driver to securely initiate your journey.
              </p>
            </td>
          </tr>
                ...
                <tr>
                  <td>
                    <p style="color:#94918C; font-size:11px; line-height:1.6; margin:0; font-weight: 400;">
                      <strong style="color: #706E6B; font-weight: 500;">Safety Protocol:</strong> Kindly verify the physical plate number matches the license credentials shown above prior to boarding. For your protection, never share this code over digital messaging paths.
                    </p>
                  </td>
                </tr>
              </table>
